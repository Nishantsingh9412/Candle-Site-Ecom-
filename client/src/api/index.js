...
// Cart APIs
// Get user's cart
export const GetCartAPI = () => API.get('/api/v1/cart/');
// Add item to cart
export const AddToCartAPI = (cartData) => API.post('/api/v1/cart/add', cartData);
// Update cart item quantity
export const UpdateCartItemAPI = (updateData) => API.patch('/api/v1/cart/update', updateData);
// Remove item from cart
export const RemoveFromCartAPI = (productId) => API.delete(`/api/v1/cart/remove/${productId}`);
// Clear entire cart
export const ClearCartAPI = () => API.delete('/api/v1/cart/clear');
// Sync cart (bulk operations)
export const SyncCartAPI = (cartData) => API.post('/api/v1/cart/sync', cartData);
