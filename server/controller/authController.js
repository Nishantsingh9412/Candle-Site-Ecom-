...
export const SignupController = async (req, res) => {
  const { fname, lname, email, otp, password, confirm_password } = req.body;

  console.log("Request body:", req.body);

  if (!fname || !lname || !otp || !email || !password || !confirm_password) {
  ...
  try {
    ...
    if (existingUser) {
      ...
      // Optionally, you can also set a cookie with the token
