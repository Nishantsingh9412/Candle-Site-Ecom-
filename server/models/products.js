...
//       default: ["https://via.placehold.co/480x634?text=Product+Image"],
//     },
//     category: {
//       type: mongoose.Schema.Types.ObjectId,
//       ref: "Category",
...
const ProductSchema = new mongoose.Schema(
  {
    ...
    images: {
      type: [String], // Array of image URLs
      required: true,
      default: ["https://placehold.co/480x634?text=Product+Image"],
    },
    additionalImages: {
    ...
    shipping_weight: { type: String }, // e.g., "3 kg"
    shipping_length: { type: String }, // e.g., "20 cm"
